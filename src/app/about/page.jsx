    ...
    <div className="bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100 min-h-screen">
      ...
      <main className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-16 p-6">
        ...
        <div className="flex-1">
          <h2 className="text-4xl font-bold">I&rsquo;m Piero. I live in Utah, where I develop my future.</h2>
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 space-y-3">
            ...
            <p className="flex items-center space-x-2">
              ...
              <Link href="https://github.com/yourprofile" className="text-blue-500 dark:text-blue-300">Follow me on GitHub</Link>
            </p>
            <p className="flex items-center space-x-2">
              <FaLinkedin className="text-blue-500 dark:text-blue-300" size={20} />
              <Link href="https://www.linkedin.com/in/pieroguzmanmora" className="text-blue-500 dark:text-blue-300">Follow me on LinkedIn</Link>
            </p>
          </div>
